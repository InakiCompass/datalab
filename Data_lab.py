...
df = pd.read_csv('https://raw.githubusercontent.com/InakiCompass/dash_app/master/SG6.csv',header=[0,1],index_col=[0])#,index_col=0)
df1 = pd.read_csv('https://raw.githubusercontent.com/InakiCompass/dash_app/master/SG6.csv')
